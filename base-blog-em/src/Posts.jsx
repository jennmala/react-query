...
export function Posts() {
  ...
  const { data, isError, error, isLoading, isFetching } = useQuery(['posts', currentPage], () => (fetchPosts(currentPage)), { 
      staleTime: 2000,
      keepPreviousData: true,  
     }); 
  // is Fetching = async query function has not yet resolved
  // isLoading = isFetching + no data in cache
